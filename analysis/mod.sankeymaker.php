...
if ($_GET["col1_type"] == "source") {
    echo "selected";
};
?>>sources</option>
                    <option value="from_user_lang" <?php
                            if ($_GET["col1_type"] == "from_user_lang") {
                                echo "selected";
                            };
?>>languages</option>
...
?>>hashtags</option>
            ...
            <div class="form_row">
                ...
                <select name="col2_type">
                    <option value="source" <?php
                            if ($_GET["col2_type"] == "source") {
                                echo "selected";
                            };
?>>sources</option>
                    <option value="from_user_lang" <?php
                            if ($_GET["col2_type"] == "from_user_lang") {
                                echo "selected";
                            };
?>>languages</option>
                    <option value="hashtag" <?php
...
?>>hashtags</option>
            ...
            <div class="form_row">
                <input name="discard_other" type="checkbox" <?php
...
<?php
$av1 = array_values($toplists["col1"]);
$av2 = array_values($toplists["col2"]);
if ($av1[0] > $av2[0])
    $highest = $av1[0];
else
    $highest = $av2[0];
