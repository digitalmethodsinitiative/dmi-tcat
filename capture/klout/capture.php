...
// db table: from_user_name (foreign), kloutscore, daychanges, weekchanges, monthchanges, topics, last updated

require_once '../../config.php';
require_once BASE_FILE.'analysis/common/functions.php';
require_once 'KloutAPIv2-PHP/KloutAPIv2.class.php';

// @todo, add $kloutapi_key to config.php.example
...
while ($res = mysql_fetch_assoc($rec)) {
    ...
    // @todo catch if klout does not return id: insert nills in db
...
// topics
    ...
    $select2 = "SELECT id FROM " . $esc['mysql']['dataset'] . "_klout k WHERE screen_name = '" . mysql_real_escape_string($from_user_name) . "'";
    $rec2 = mysql_query($select2);
